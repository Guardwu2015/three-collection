...
const IMGURL = 'https://assets.codepen.io/9234665/E4484616-BDB4-4AB8-8A83-84A50CF12C79_1_201_a.jpeg';
const RATIO = 62 / 901; 
...
sphereMesh.rotation.x=-.5;
camera.position.set(0, 0, 0);

//// Anim

function animate(t /*sec*/) {
    mat.uniforms.t.value = t*.01;
  sphereMesh.rotation.x -= 0.0001;
  sphereMesh.rotation.z += 0.000001;
  mat.uniforms.textureScale.value +=.0000001;
}